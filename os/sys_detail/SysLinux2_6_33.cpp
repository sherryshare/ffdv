 ...
 * =====================================================================================
 */
#include "SysLinux2_6_33.h"
#include "../../utils/PUtils.h"
#include <stdio.h>
#include <sys/vfs.h>

namespace os{
SysLinux2_6_33::SysLinux2_6_33()
	: m_iBlockSize(-1),
	m_iCoreNums(-1),
	m_iCPUNums(-1),
	m_iPageSize(-1),
...
std::string SysLinux2_6_33::getOSVersion()
{
	return m_strOSVersion;
}

int SysLinux2_6_33::getCPUNums()
{
	if(m_iCPUNums < 0)
...
int SysLinux2_6_33::getCPUUsedRate()
{
...
int SysLinux2_6_33::getCoreNums()
{
	if(m_iCoreNums <= 0)
		return addError("unsupported!");
	return m_iCoreNums;
...
std::vector<cpu_info_detail> SysLinux2_6_33::getCPUInfo()
{
	m_oCPUInfo.clear();
	return m_oCPUInfo;
}

int SysLinux2_6_33::getPhysicalMem()
{
	if(m_iPhysicalMem <= 0)
		return addError("unsupported!");
...
int SysLinux2_6_33::getPhysicalUsedMem()
{
...
int SysLinux2_6_33::getBlockSize()
{
	if(m_iBlockSize <= 0)
		return addError("unsupported!");
	return m_iBlockSize;
...
int SysLinux2_6_33::getPageSize()
{
	if(m_iPageSize <= 0)
		return addError("unsupported!");
	return m_iPageSize;
...
int SysLinux2_6_33::getLoadAvg1()
{
...
int SysLinux2_6_33::getLoadAvg5()
{
	std::string res = readProcFile("/proc/loadavg");
	float la1, la5, la15;
	sscanf(res.c_str(), "%f %f %f ", &la1, &la5, &la15);
...
int SysLinux2_6_33::getLoadAvg15()
{
	std::string res = readProcFile("/proc/loadavg");
	float la1, la5, la15;
	sscanf(res.c_str(), "%f %f %f ", &la1, &la5, &la15);
...
int SysLinux2_6_33::getProcessNums()
{
	return addError("unsupported!");
}

std::vector<proc_info_detail> SysLinux2_6_33::getProcInfo()
{
	m_oProcInfo.clear();
	return m_oProcInfo;
}

std::string SysLinux2_6_33::readProcFile(const char * filepath)
{
...
fsinfo SysLinux2_6_33::getFSInfo()
{
	return m_ofsinfo;
}

int SysLinux2_6_33::getInNetRate()
{
...
int SysLinux2_6_33::getOutNetRate()
{
	struct timeval curtime;
	gettimeofday(&curtime, NULL);
	if(curtime.tv_sec == m_oLastCalltime.tv_sec)
