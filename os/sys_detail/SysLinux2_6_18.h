//////////////////////////////////////////////////////////////////////////
/*
AthrunArthur 2010-6-17，本类针对linux内核2.6.18版本，对其他版本不保证兼容性，
本类使用了/proc文件系统中的文件，由于不同版本的内核对文件中字段的定义有一定的差别，
因此在其他版本的内核中使用时，需谨慎。
*/
//////////////////////////////////////////////////////////////////////////
#ifndef _SYS_LINUX2_6_18_H
#define _SYS_LINUX2_6_18_H
...
namespace os{
class SysLinux2_6_18: public ISysInfo
{
public:
	SysLinux2_6_18(void);
	virtual ~SysLinux2_6_18(void);
